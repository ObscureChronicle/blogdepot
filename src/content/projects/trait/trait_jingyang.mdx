...
<TraitWiki
  ...
  baseOwner={['蔡瑁', '曹仁', '曹休', '陈表', '陈骞', '陈式', '邓飏', '邓芝', '丁奉', '费祎', '冯习', '傅肜', '黄忠', '蒋济', '蒋琬', '阚泽', '蒯良', '蒯越', '廖化', '廖立', '李绩', '刘琮', '刘陶', '刘晔', '留赞', '李严', '陆康', '鲁淑', '鲁肃', '陆逊', '吕蒙', '马谡', '庞统', '潘濬', '施明', '士燮', '史招', '宋衷', '孙策', '孙綝', '孙登', '孙和', '孙奂', '孙峻', '孙权', '魏延', '文聘', '向充', '向宠', '向朗', '杨仪', '虞翻', '张奋', '张南', '周泰', '州泰', '周胤', '周瑜', '朱然']}
  dlcOwner={[]}
  baseDescription={''}
  dlcDescription={''}
  effect={''}
