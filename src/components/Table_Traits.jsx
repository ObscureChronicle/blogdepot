...
const TRAIT_MAP = {
    ...
    '卧龙': { color: TraitColor.Super, link: '' },
    ...
    '神弓': { color: TraitColor.Super, link: '' },
    ...
    '玄音': { color: TraitColor.Super, link: '' },
    '貔貅': { color: TraitColor.Super, link: '' },
    '神恙': { color: TraitColor.Super, link: '' },
    '天予': { color: TraitColor.Super, link: '' },
    '若愚': { color: TraitColor.Super, link: '' },
    '雷发': { color: TraitColor.Super, link: '' },
    '同雠': { color: TraitColor.Super, link: '' },
    '虓阚': { color: TraitColor.Super, link: '' },
